...
####################  Layer1  ###########################
        ...
        with tf.compat.v1.variable_scope('layer1_far'):
            weights=tf.compat.v1.get_variable("w1_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer1_far/w1_far')))
            bias=tf.compat.v1.get_variable("b1_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer1_far/b1_far')))
...
####################  Layer2  ###########################           
        ...
        with tf.compat.v1.variable_scope('layer2_far'):
            weights=tf.compat.v1.get_variable("w2_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer2_far/w2_far')))
            bias=tf.compat.v1.get_variable("b2_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer2_far/b2_far')))
        ...
        with tf.compat.v1.variable_scope('layer2_3_far'):
            weights=tf.compat.v1.get_variable("w2_3_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer2_3_far/w2_3_far')))
            bias=tf.compat.v1.get_variable("b2_3_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer2_3_far/b2_3_far')))
...
####################  Layer3  ###########################                 
        ...
        with tf.compat.v1.variable_scope('layer3_far'):
            weights=tf.compat.v1.get_variable("w3_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer3_far/w3_far')))
            bias=tf.compat.v1.get_variable("b3_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer3_far/b3_far')))
        ...
        with tf.compat.v1.variable_scope('layer3_4_far'):
            weights=tf.compat.v1.get_variable("w3_4_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer3_4_far/w3_4_far')))
            bias=tf.compat.v1.get_variable("b3_4_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer3_4_far/b3_4_far')))
...
####################  Layer4  ###########################                 
        ...
        with tf.compat.v1.variable_scope('layer4_far'):
            weights=tf.compat.v1.get_variable("w4_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer4_far/w4_far')))
            bias=tf.compat.v1.get_variable("b4_far",initializer=tf.constant(reader.get_tensor('fusion_model/layer4_far/b4_far')))
...
for idx_num in range(19,20):
  ...
  while(num_epoch==idx_num):
      ...
      with tf.name_scope('VI_input'):
          images_far = tf.compat.v1.placeholder(tf.float32, [1,None,None,None], name='images_far')
